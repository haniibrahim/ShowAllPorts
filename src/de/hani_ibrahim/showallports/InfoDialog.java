package de.hani_ibrahim.showallports;//GEN-FIRST:event_lb_emailMouseClicked
...
public class InfoDialog extends javax.swing.JDialog {
    ...
    private void lb_emailMouseClicked(java.awt.event.MouseEvent evt) {                                      
        openUri(uri);
    }                                     

    private void lb_emailMouseEntered(java.awt.event.MouseEvent evt) {                                      
        setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
    }                                     

    private void lb_emailMouseExited(java.awt.event.MouseEvent evt) {                                     
